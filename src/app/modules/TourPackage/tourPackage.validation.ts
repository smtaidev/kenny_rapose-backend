...
export const createTourPackageZodSchema = z.object({
  body: z.object({
    ...
    packagePrice: z.number().positive('Package price must be positive').max(100000, 'Package price cannot exceed 100000'),
    ...
    tourDuration: z.number().int('Tour duration must be a whole number').positive('Tour duration must be positive').max(365, 'Tour duration cannot exceed 365 days'),
...
export const updateTourPackageZodSchema = z.object({
  body: z.object({
    ...
    packagePrice: z.number().positive('Package price must be positive').max(100000, 'Package price cannot exceed 100000').optional(),
    ...
    tourDuration: z.number().int('Tour duration must be a whole number').positive('Tour duration must be positive').max(365, 'Tour duration cannot exceed 365 days').optional(),
