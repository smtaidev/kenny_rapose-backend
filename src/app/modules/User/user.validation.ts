...
export const updateUserProfileMixedZodSchema = z.object({
  body: z.object({
    data: z.string().min(1, 'User profile data is required'), // JSON string from form data
  }),
});
...
export const userProfileDataSchema = z.object({
  ...
  dateOfBirth: z.string().datetime('Date of birth must be a valid date').optional(),
  phone: z
    .string()
