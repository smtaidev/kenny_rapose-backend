...
exports.updateUserRoleZodSchema = exports.resetPasswordZodSchema = exports.changePasswordZodSchema = exports.verifyOtpZodSchema = exports.requestOtpZodSchema = exports.updateUserProfileZodSchema = exports.userProfileDataSchema = exports.updateUserProfileMixedZodSchema = void 0;
const zod_1 = require("zod");
// Mixed approach validation schemas (JSON data + photos as form data)
exports.updateUserProfileMixedZodSchema = zod_1.z.object({
    body: zod_1.z.object({
        data: zod_1.z.string().min(1, 'User profile data is required'), // JSON string from form data
    }),
});
...
exports.userProfileDataSchema = zod_1.z.object({
    ...
    dateOfBirth: zod_1.z.string().datetime('Date of birth must be a valid date').optional(),
    phone: zod_1.z
        .string()
    ...
    zip: zod_1.z
        ...
        .optional(),
    country: zod_1.z.string().min(1, "Country cannot be empty").optional(),
});
// Legacy validation schema (keeping for backward compatibility)
