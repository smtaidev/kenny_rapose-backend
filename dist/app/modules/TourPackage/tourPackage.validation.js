...
exports.updateTourPackageZodSchema = exports.deletePhotosZodSchema = exports.updateTourPackageWithPhotosZodSchema = exports.createTourPackageWithPhotosZodSchema = exports.createTourPackageZodSchema = void 0;
...
exports.createTourPackageZodSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        packagePriceAdult: zod_1.z.number().positive('Adult package price must be positive').max(100000, 'Adult package price cannot exceed 100000'),
        packagePriceChild: zod_1.z.number().positive('Child package price must be positive').max(100000, 'Child package price cannot exceed 100000'),
...
exports.deletePhotosZodSchema = zod_1.z.object({
    body: zod_1.z.object({
        photoUrls: zod_1.z.array(zod_1.z.string().url('Photo URL must be valid')).min(1, 'At least one photo URL must be provided').max(20, 'Cannot delete more than 20 photos at once'),
    }),
});
