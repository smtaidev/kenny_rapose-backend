...
exports.googleSignInZodSchema = exports.refreshTokenZodSchema = exports.loginUserZodSchema = exports.createUserZodSchema = void 0;
...
exports.createUserZodSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        lastName: zod_1.z.string().min(1, "Last name cannot be empty"),
...
exports.googleSignInZodSchema = zod_1.z.object({
    body: zod_1.z.object({
